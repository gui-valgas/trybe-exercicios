...
class MessaginProtocol(Protocol):
...
class InMemoryMessaging(MessaginProtocol):
...
class FileMessaging(MessaginProtocol):
...
class Main:
    def main(self):
        ...
        file_messaging.send_message("Paulo", "Como está?")
