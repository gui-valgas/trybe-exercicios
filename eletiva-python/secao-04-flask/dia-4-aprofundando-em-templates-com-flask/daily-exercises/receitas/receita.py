...
data = {
    ...
    'preparo': 'bata o leite condensado junto com o creme de leite e '
    'os ovos no liquidificador por 5 minutos, enquanto isso, coloque o '
    'açúcar na frigideira até virar caramelo, ponha o caramelo em uma forma '
    'e despeje a misturam em cima, coloque para gelar'
}
