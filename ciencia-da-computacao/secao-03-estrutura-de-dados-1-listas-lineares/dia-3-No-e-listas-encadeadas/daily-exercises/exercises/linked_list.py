...
class LinkedList:
    ...
    # Outra forma de implementar o clear, porem funciona graças ao
...
# O método get_element_at realiza a busca de um item em qualquer local da
# lista, portanto sua Complexidade de tempo é O(n).
